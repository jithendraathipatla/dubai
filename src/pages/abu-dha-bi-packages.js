...
const Allpackages = () => {
  ...
  return (
    <LayoutComponent>
      <div css={landing}>
        <h1>Abu Dhabi KINGDOM MAINLAND COMPANY INCORPORATION</h1>
        <span>Company formation packages starting from AED 14,000</span>
      </div>
      <div>
        <SecondHOC title="All Packages in Abu Dhabi">
          <br />
          ...
          <div css={aftercard}>
           ...
           Planning on company registration in Abu Dhabi freezone? Abu Dhabi offers more
           than 20 freezones and has some of the most prestigious freezones in
           the UAE. Abu Dhabi freezones offer world-class business amenities, options
           ...
           limited reporting obligations. While Abu Dhabi free zone business setup
           allows you to enjoy all the benefits of no taxation and import duty
           exemptions that mainland Abu Dhabi companies enjoy, it also gives you the
           benefit of 100% ownership over your company. However, with freezone
           business setup in Abu Dhabi you can do business internationally and not
