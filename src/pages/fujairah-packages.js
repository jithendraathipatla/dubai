...
const Allpackages = () => {
  ...
  return (
    <LayoutComponent>
      <div css={landing}>
        <h1>FUJAIRAH KINGDOM MAINLAND COMPANY INCORPORATION</h1>
        <span>Company formation packages starting from AED 14,000</span>
      </div>
      <div>
        <SecondHOC title="All Packages in FUJAIRAH">
          <br />
          ...
          <div css={aftercard}>
           ...
           Planning on company registration in Fujairah freezone? Fujairah offers more
           than 20 freezones and has some of the most prestigious freezones in
           the UAE. Fujairah freezones offer world-class business amenities, options
           ...
           limited reporting obligations. While Fujairah free zone business setup
           allows you to enjoy all the benefits of no taxation and import duty
           exemptions that mainland Fujairah companies enjoy, it also gives you the
           benefit of 100% ownership over your company. However, with freezone
           business setup in Fujairah you can do business internationally and not
