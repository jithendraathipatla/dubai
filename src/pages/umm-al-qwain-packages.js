...
const Allpackages = () => {
  ...
  return (
    <LayoutComponent>
      <div css={landing}>
        <h1>UMM AL QWAIN KINGDOM MAINLAND COMPANY INCORPORATION</h1>
        <span>Company formation packages starting from AED 12,000</span>
      </div>
      <div>
        <SecondHOC title="All Packages in Umm Al Qwain">
          <br />
          ...
          <div css={aftercard}>
           ...
           Planning on company registration in Umm Al Qwain freezone? Umm Al Qwain offers more
           than 20 freezones and has some of the most prestigious freezones in
           the UAE. Umm Al Qwain freezones offer world-class business amenities, options
           ...
           limited reporting obligations. While Umm Al Qwain free zone business setup
           ...
           <br />
           <br />
           While Umm Al Qwain free zone business setup
           allows you to enjoy all the benefits of no taxation and import duty
           exemptions that mainland Ras Al Khaima companies enjoy, it also gives you the
         ...
         limited reporting obligations. While Umm Al Qwain free zone business setup
         allows you to enjoy all the benefits of no taxation and import duty
         exemptions that mainland Umm Al Qwain companies enjoy, it also gives you the
         benefit of 100% ownership over your company.
         </div>
         <br />
         <br />
