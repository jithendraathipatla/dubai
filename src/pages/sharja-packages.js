...
const Allpackages = () => {
  ...
  return (
    <LayoutComponent>
      <div css={landing}>
        <h1>Sharja KINGDOM MAINLAND COMPANY INCORPORATION</h1>
        <span>Company formation packages starting from AED 14,000</span>
      </div>
      <div>
        <SecondHOC title="All Packages in Sharja">
          <br />
          ...
          <div css={aftercard}>
           ...
           Planning on company registration in Sharja freezone? Sharja offers more
           than 20 freezones and has some of the most prestigious freezones in
           the UAE. Sharja freezones offer world-class business amenities, options
           ...
           limited reporting obligations. While Sharja free zone business setup
           allows you to enjoy all the benefits of no taxation and import duty
           exemptions that mainland Sharja companies enjoy, it also gives you the
           benefit of 100% ownership over your company. However, with freezone
           business setup in Sharja you can do business internationally and not
