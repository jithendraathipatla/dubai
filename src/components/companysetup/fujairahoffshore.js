...
const BusinessSetupInDiera = () => {
  return (
    <>
      <BusinessSetupHOC
        main="OFFSHORE COMPANY FORMATION IN FUJAIRAH"
        submain="Hassle-free, tax-free, and secure offshore company formation in FUJAIRAH        "
        hetchfour="OFFSHORE COMPANY FORMATION IN FUJAIRAH"
      >
        <div>
          <br />
          <span>
            ...
            in 2007 and allowed offshore company registration in FUJAIRAH.
            ...
            up an offshore company in FUJAIRAH because it is more
            ...
            formation in FUJAIRAH free zones an attractive option. You
            ...
            offshore company in FUJAIRAH within two days, sitting anywhere
            ...
            <br />
            <h1 style={{ fontSize: "22px", color: "black" }}>
              WHAT ARE THE BENEFITS OF STARTING A FUJAIRAH OFFSHORE
              COMPANY?
            </h1>
            <br />
            <br />
            <ul css={list}>
              ...
              <li>
                <FaDotCircle /> You can have a bank account in Ras Al Khaimah
                LLCs
              </li>
              <li>
            ...
            <br />
            <h1 style={{ fontSize: "22px", color: "black" }}>
              WHY START A OFFSHORE COMPANY IN RAS AL KHAIMAH WITH SEVAGO?
            </h1>
            <br />
            ...
            Khaimah can become tough. Our Ras Al Khaimah freezone business set
