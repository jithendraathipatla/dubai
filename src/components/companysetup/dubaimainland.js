...
const Dubaimainland = () => {
  const data = [
    ...
    },
    {
      ...
      path: "/business-setup-in-diera-dubai",
      name: "DEIRA",
      paragraph:
    ...
    },
    {
      ...
      path: "/business-setup-in-jumirah",
      name: "JUMEIRAH",
      paragraph:
    ...
    },
    {
      img:
        "https://www.shuraa.com/wp-content/uploads/2019/09/sheikh-zayed-dubai-uae.jpg",
      path: "/business-setup-in-sheik-zayed-road",
    ...
    },
    {
      ...
      path: "/business-setup-in-business-bay-dubai",
      name: "BUSINESS BAY",
      paragraph:
    ...
    },
    {
      ...
      name: "AL QUSAIS",
      path: "/business-setup-in-alqusais",
      paragraph:
