...
const BusinessSetupInDiera = () => {
  return (
    <>
      <BusinessSetupHOC
        main="OFFSHORE COMPANY FORMATION IN UMM AL QWAIN"
        submain="Hassle-free, tax-free, and secure offshore company formation in UMM AL QWAIN        "
        hetchfour="OFFSHORE COMPANY FORMATION IN UMM AL QWAIN"
      >
        <div>
          <br />
          <span>
            ...
            in 2007 and allowed offshore company registration in UMM AL QWAIN.
            ...
            up an offshore company in UMM AL QWAIN because it is more
            ...
            formation in UMM AL QWAIN free zones an attractive option. You
            ...
            offshore company in UMM AL QWAIN within two days, sitting anywhere
            ...
            <br />
            <h1 style={{ fontSize: "22px", color: "black" }}>
              WHAT ARE THE BENEFITS OF STARTING A UMM AL QWAIN OFFSHORE
              COMPANY?
            </h1>
            <br />
            <br />
            <ul css={list}>
              ...
              <li>
                <FaDotCircle /> You can have a bank account in UMM AL QWAIN
                LLCs
              </li>
              <li>
            ...
            <br />
            <h1 style={{ fontSize: "22px", color: "black" }}>
              WHY START A OFFSHORE COMPANY IN UMM AL QWAIN WITH SEVAGO?
            </h1>
            <br />
            ...
            Khaimah can become tough. Our UMM AL QWAIN freezone business set
