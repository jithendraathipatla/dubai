...
const Dubaimainland = () => {
  ...
  return (
    <div style={{ textAlign: "justify" }}>
      <div css={main}>
        <h1>Company Spaces from Ajman Free Zone</h1>
      </div>
      <br />
      <span>
        <h1 style={{ fontSize: "22px", color: "black" }}>Company Spaces from Ajman Free Zone</h1>
        <br />
...
const main = css`
  ...
  min-height: 301px;
  color: white;
  background: url("https://www.shuraa.com/wp-content/uploads/2020/04/Business-setup-in-Ajman-Mainland.jpg");
  h1 {
    font-size: 30px;
    padding-top: 12%;
  }
