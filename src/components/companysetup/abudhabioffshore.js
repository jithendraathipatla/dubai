...
const BusinessSetupInDiera = () => {
  return (
    <>
      <BusinessSetupHOC
        main="OFFSHORE COMPANY FORMATION IN ABU DHABI"
        submain="Hassle-free, tax-free, and secure offshore company formation in ABU DHABI        "
        hetchfour="OFFSHORE COMPANY FORMATION IN ABU DHABI"
      >
        <div>
          <br />
          <span>
            ...
            in 2007 and allowed offshore company registration in ABU DHABI.
            ...
            up an offshore company in ABU DHABI because it is more
            ...
            formation in ABU DHABI free zones an attractive option. You
            ...
            offshore company in ABU DHABI within two days, sitting anywhere
            ...
            <br />
            <h1 style={{ fontSize: "22px", color: "black" }}>
              WHAT ARE THE BENEFITS OF STARTING A ABU DHABI OFFSHORE
              COMPANY?
            </h1>
            <br />
            <br />
            <ul css={list}>
              ...
              <li>
                <FaDotCircle /> You can have a bank account in ABU DHABI
                LLCs
              </li>
              <li>
            ...
            <br />
            <h1 style={{ fontSize: "22px", color: "black" }}>
              WHY START A OFFSHORE COMPANY IN ABU DHABI WITH SEVAGO?
            </h1>
            <br />
            ...
            Khaimah can become tough. Our ABU DHABI freezone business set
