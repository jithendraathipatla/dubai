...
const Dubaimainland = () => {
  ...
  return (
    <div style={{textAlign:"justify"}}>
      <div css={main}>
        <h1>Company Spaces from Ras Al Khaimah Main Land</h1>
      </div>
      <br />
      <span>
      <h1 style={{ fontSize: "22px", color: "black" }}>Company Spaces from Ras Al Khaimah Main Land</h1>
      <br />
      
      Hassle-free and affordable business setup solutions for new businesses
      in Ras Al Khaimah Mainland
      <br />
      <br />
      As a growing economy, Ras Al Khaimah’s large-scale development is drawing a lot
      ...
      <br />
      <br />
      Business setup in Ras Al Khaimah mainland is easy and economical. It offers
      businesses opportunities for growth and global exposure. Another reason
      for its growing popularity is the affordable cost of an Ras Al Khaimah mainland
      business license.
      <br />
      <br />
      <h1 style={{ fontSize: "22px", color: "black" }}>HOW TO START A BUSINESS IN RAS AL KHAIMAH</h1>
      <br />
    
      The general process of setting up a business in Ras Al Khaimah mainland is to
      ...
      business in Ras Al Khaimah mainland.
      <br />
      <br />
      ...
      setup in Ras Al Khaimah, UAE. Company registration in Ras Al Khaimah offers several
      ...
      business setup packages for Ras Al Khaimah mainland that cover a range of
    ...
    <br />
    There are several advantages of business setup in Ras Al Khaimah, some of which are
    the following:
    <br />
    <br />
    <ul css={list}>
      <li>
        <FaDotCircle /> Company registration in Ras Al Khaimah offers low-cost rented
        commercial spaces and offices
      </li>
      <li>
        <FaDotCircle /> LLC license cost in Ras Al Khaimah is comparatively more
        reasonable than most other emirates
      </li>
      <li>
        <FaDotCircle /> Manufacturing units prefer business set-up in Ras Al Khaimah
        due to easy lease options
      </li>
      <li>
        <FaDotCircle /> Ras Al Khaimah provides easy access to two international
        airports and four ports
      </li>
      <li>
        <FaDotCircle /> Company formation in Ras Al Khaimah is ideal for industries as
...
const main = css`
  ...
  min-height: 301px;
  color: white;
  background: url("https://blog.raynatours.com/wp-content/uploads/2019/05/ras-al-khaimah-banner.jpg");
  h1 {
    font-size: 30px;
    padding-top: 12%;
  }
